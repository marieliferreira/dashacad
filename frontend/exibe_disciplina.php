...
<div id="div-tbl">
    ...
    <?php
        ...
        // Consulta SQL para selecionar todas as disciplinas cadastradas
        $sql = "SELECT * FROM tbl_disciplina";
        ...
        if ($result = $mysqli->query($sql)) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td id='tbl-cod-disciplina'>" . $row["DIS_CODIGO"] . "</td>";
                    echo "<td id='tbl-nome-disciplina'>" . $row["DIS_NOME"] . "</td>";
                    // Você pode adicionar mais colunas conforme necessário para exibir outras informações da disciplina
