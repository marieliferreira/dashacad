...
<span ><a  class="fa fa-arrow-left" id="btn-voltar-disciplina" href="home.php"></a></span>
    <h4 id="h4-grafico-coluna">Gráficos de barras</h1>
    <br>
    <br>
    <p>
    <a id="grafico-n1" class="grafico" href="barra-formularios-respondidos.php">Quantidade de alunos que responderam ao questionário</a>
    </p>
    <p>
