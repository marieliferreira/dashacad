...
<div id="div-tbl">
<span ><a  class="fa fa-arrow-left" id="btn-voltar-form-resp" href="home_aluno.php"></a></span>
    <h4 id="h4-form-respondidos">Formulários Respondidos</h1>
        ...
        if ($result = $mysqli->query($sql)) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    // Exibe o ícone de verificado verde
