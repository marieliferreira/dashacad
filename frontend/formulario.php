          ...
          <div class="container-fluid">
              <div class="row col-md-12">
                ...
                <div class="col-sm-4 text-right botao-logout">
                      <a href=""><svg xmlns="http://www.w3.org/2000/svg"  width="25" height="25" fill="currentColor"      class="bi bi-box-arrow-right" viewBox="0 0 16 16">
...
<div id="modal-registro-form">
    <div id="div-registro-form">
    <span><a  class="fa fa-arrow-left" id="btn-voltar-registro" href="home.php"></a></span>
      <form action="../backend/registro_formulario.php" method="POST" >
        <h4 id="h4-reg-form">Criando Formulário</h4>
        <label id="titulo" for="titulo">Título:</label>
        <input type="text" id="input-titulo" name="input-titulo"><br><br>
        <label id="descricao" for="descricao">Descrição:</label>
        <input id="input-descricao" name="input-descricao"><br><br>
        <label id="lbl-turma" for="turma">Turma:</label>
        <select id="turma" name="turma" ></select>
        <label id="lbl-disciplina" for="disciplina">Disciplina:</label>
        <select id="disciplina" name="disciplina" ></select>      
        <label id="lbl-prazo-form" for="input-date-prazo">Prazo:</label>
        <input id="input-prazo-form" name="input-date-prazo" type="date"> <br><br>
